...
let package = Package(
  ...
  dependencies: [
    ...
    .package(url:"https://github.com/YOCKOW/SwiftNetworkGear.git", "0.14.6"..<"2.0.0"),
    .package(url:"https://github.com/YOCKOW/SwiftXHTML.git", from: "2.3.0"),
    .package(url:"https://github.com/YOCKOW/ySwiftExtensions.git", from: "1.7.3"),
  ],
  targets: [
